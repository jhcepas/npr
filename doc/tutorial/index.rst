...
complex phylogenetic workflow can be defined using in a few lines
(i.e. including alignment refinement and model testing steps).
...
Note also that this software is suitable for High Performance Computing.
